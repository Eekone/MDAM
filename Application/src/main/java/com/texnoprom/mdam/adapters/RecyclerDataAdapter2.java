...
public class RecyclerDataAdapter2 extends RecyclerView.Adapter<RecyclerDataAdapter2.ExpandingViewHolder> {
    private ArrayList<ExpandingRow> expandingRows;
    private Context mContext;

    public RecyclerDataAdapter2(ArrayList<ExpandingRow> expandingRows, Context mContext) {
